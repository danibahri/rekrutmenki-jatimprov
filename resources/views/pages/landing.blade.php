...
@section('content')
    <div class="content max-w-screen-lg mx-auto p-4 py-6 lg:py-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="info">
                ...
                <div class="flex items-center justify-center w-full mt-4">
                    <a href="#"
                        class="flex justify-center items-center w-full py-2 bg-blue-700 rounded-sm text-white text-center border-2 hover:border-2 hover:border-blue-800 hover:bg-blue-600">Daftar
                ...
                <div class="grid grid-cols-3 gap-3 mt-4">
                    <div class="card bg-white p-4 rounded-lg shadow-md">
                        ...
                        <p class="flex justify-center items-center text-gray-500 mt-3"><span
                                class="bg-red-100 text-red-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded">Di
                                tutup</span>
                        </p>
                    </div>
                    <div class="card bg-white p-4 rounded-lg shadow-md">
                    ...
                    <div class="card bg-white p-4 rounded-lg shadow-md">
                        ...
                        <hr>
                        <p class="flex justify-center items-center text-gray-500 mt-3"><span
                                class="bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded">1.800</span>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="card mt-8 w-full bg-white p-5 rounded-lg shadow-md">
            <h1 class="font-semibold text-xl">Alur Pendaftaran</h1>
            <div class="mt-5">
                <ol class="items-center grid grid-cols-1 md:grid-cols-4">
                    <li class="relative mb-6 md:mb-4 sm:mb-0">
                        ...
                        <div class="mt-3 sm:pe-8">
                            <h3 class="text-lg font-semibold text-gray-900">Flowbite Library v1.0.0</h3>
                            <time class="block mb-2 text-sm font-normal leading-none text-gray-400">Released on December 2,
                                2021</time>
                    ...
                    <li class="relative mb-6 md:mb-4 sm:mb-0">
                        ...
                        <div class="mt-3 sm:pe-8">
                            <h3 class="text-lg font-semibold text-gray-900">Flowbite Library v1.2.0</h3>
                            <time class="block mb-2 text-sm font-normal leading-none text-gray-400">Released on December 23,
                                2021</time>
                            <p class="text-base font-normal text-gray-500">Get started with dozens of web components and
                                interactive elements.</p>
                        </div>
                    ...
                    <li class="relative mb-6 md:mb-4 sm:mb-0">
                        ...
                        <div class="mt-3 sm:pe-8">
                            <h3 class="text-lg font-semibold text-gray-900">Flowbite Library v1.3.0</h3>
                            <time class="block mb-2 text-sm font-normal leading-none text-gray-400">Released on January 5,
                                2022</time>
                            <p class="text-base font-normal text-gray-500">Get started with dozens of web components and
                                interactive elements.</p>
                        </div>
