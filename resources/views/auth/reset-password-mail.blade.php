    ...
    <div class="relative max-w-sm mx-auto p-8 mt-6 bg-white sm:my-20 rounded-lg shadow-md">
        ...
        <div class="text-center mb-8">
            ...
            <div class="bg-blue-50 rounded-lg p-4 mb-6">
                ...
                <p class="font-mono text-blue-600 font-semibold">30 menit</p>
            </div>
        </div>
        ...
        <div class="text-center text-sm text-gray-600 mb-8 max-w-sm mx-auto">
            <p>atau klik link di bawah ini:</p>
            <a href="{{ route('reset.password', ['token' => $token]) }}"
                class="block mt-2 text-blue-600 hover:underline max-w-full truncate">
        ...
        <div class="text-center text-sm text-gray-600">
            <p class="mb-4">Jika Anda tidak meminta reset password, abaikan email ini atau hubungi kami untuk
                keamanan
                akun Anda.</p>
